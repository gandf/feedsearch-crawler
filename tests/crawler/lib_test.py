...
def test_coerce_url():
    assert coerce_url("test.com") == URL("https://test.com")
    assert coerce_url("https://test.com") == URL("https://test.com")
    assert coerce_url("https://test.com") == URL("https://test.com")
    assert coerce_url("test.com/path/path2") == URL("https://test.com/path/path2")
    ...
    assert coerce_url("test.com/path/path2", https=True) == URL("https://test.com/path/path2")
    assert coerce_url("//test.com") == URL("https://test.com")
    assert coerce_url("feed://test.com") == URL("feed://test.com")
    assert coerce_url("feed://www.internet-law.de/?feed=/feed/") == URL("feed://www.internet-law.de/?feed=/feed/")
